    ...
    \begin{column}{0.65\textwidth}
      \begin{figure}[t]
        ...
        \begin{tikzpicture}[x=\x,y=-\y,inner sep=0mm]
          ...
          \begin{pgfonlayer}{background}
            \begin{scope}[rounded corners=2pt]
              \fill[codebg]                                          (-5.5, -1.00) rectangle (36.0, 20.00);

              \fill[codeConstant,draw=codeConstant,line width=1.7pt] (-4.0, -0.00) rectangle (34.5, 19.20);
              \fill[codeConstant!25]                                 (-2.5, -0.00) rectangle (34.5, 19.20);

              \fill[codeString,draw=codeString,line width=1.7pt]     (-2.0,  2.60) rectangle (33.5,  8.20);
              \fill[codeString!25]                                   (-0.5,  2.60) rectangle (33.5,  8.20);

              \fill[codeString,draw=codeString,line width=1.7pt]     (-2.0,  8.70) rectangle (33.5, 18.60);
              \fill[codeString!25]                                   (-0.5,  8.70) rectangle (33.5, 18.60);
